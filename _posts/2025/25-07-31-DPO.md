...
![Alt text](/code25/assets/images/2025/25-07-31-DPO_files/pd.png)
and it can be integrated in to Bradley-Terry model
![Alt text](/code25/assets/images/2025/25-07-31-DPO_files/bt.png)

## 2 DPO in LLM Training
The DPO is replacing RLHF in the LLM training workflow
![Alt text](/code25/assets/images/2025/25-07-31-DPO_files/dpo_llm.png)
The standard RFHF has a reward model within its objective function
1. It uses explicit reward model
2. Use PPO to train RL
![Alt text](/code25/assets/images/2025/25-07-31-DPO_files/rlhf_loss.png)
But with DPO, we use 
1. implicit reward model within the policy itsel
2. indirectly derives the optimal policy from 
![Alt text](/code25/assets/images/2025/25-07-31-DPO_files/dpo_paper.png)

Here is the loss function for DPO
![Alt text](/code25/assets/images/2025/25-07-31-DPO_files/dpo_loss.png)
...
![Alt text](/code25/assets/images/2025/25-07-31-DPO_files/pf.png)
and defines **optimal policy**as below
![Alt text](/code25/assets/images/2025/25-07-31-DPO_files/op.png)
you can see that
...
![Alt text](/code25/assets/images/2025/25-07-31-DPO_files/klmini.png)
...
![Alt text](/code25/assets/images/2025/25-07-31-DPO_files/dpo4.png)
