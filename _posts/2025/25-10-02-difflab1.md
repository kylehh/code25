...
![Alt text](/code25/assets/images/2025/25-10-02-difflab1_files/euler.png)
```python
...
![Alt text](/code25/assets/images/2025/25-10-02-difflab1_files/brownian.png)
...
![Alt text](/code25/assets/images/2025/25-10-02-difflab1_files/ou.png)
```python
class OUProcess(SDE):
...
![Alt text](/code25/assets/images/2025/25-10-02-difflab1_files/ousame.png)
...
![Alt text](/code25/assets/images/2025/25-10-02-difflab1_files/dist.png)
...
class LangevinSDE(SDE):
    ...
    def diffusion_coefficient(self, xt: torch.Tensor, t: torch.Tensor) -> torch.Tensor:
        ...
        return self.sigma * torch.ones_like(xt)
```
![Alt text](/code25/assets/images/2025/25-10-02-difflab1_files/langevin.png)
