...
```
![Alt text](/code25/assets/images/2025/25-09-09-difflab2_files/gcpp_gt.png)
...
```
![Alt text](/code25/assets/images/2025/25-09-09-difflab2_files/gcpp_cvf.png)
...
xts = simulator.simulate_with_trajectory(x0, ts) # (bs, nts, dim)
```
![Alt text](/code25/assets/images/2025/25-09-09-difflab2_files/gmpp_tr.png)
...
class ConditionalProbabilityPath(torch.nn.Module, ABC):
    ...
    def sample_marginal_path(self, t: torch.Tensor) -> torch.Tensor:
        ...
        return x
```
![Alt text](/code25/assets/images/2025/25-09-09-difflab2_files/gmpp_gt.png)